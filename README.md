...
dependencies {
  ...
  testImplementation 'com.ekino.oss.jcv:jcv-core:1.3.0'
  ...
}
```
...
dependencies {
  ...
  testImplementation 'com.ekino.oss.jcv:jcv-assertj:1.3.0'
  ...
}
```
...
dependencies {
  ...
  testImplementation 'com.ekino.oss.jcv:jcv-hamcrest:1.3.0'
  ...
}
```
