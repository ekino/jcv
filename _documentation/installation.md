...
<dependencies>
  ...
  <dependency>
    ...
    <version>{{ site.data.jcv.release.version.latest }}</version>
    <scope>test</scope>
  </dependency>
  ...
</dependencies>
...
dependencies {
  ...
  testImplementation 'com.ekino.oss.jcv:jcv-core:{{ site.data.jcv.release.version.latest }}'
  ...
}
```
...
dependencies {
  ...
  testImplementation 'com.ekino.oss.jcv:jcv-assertj:{{ site.data.jcv.release.version.latest }}'
  ...
}
```
...
dependencies {
  ...
  testImplementation 'com.ekino.oss.jcv:jcv-hamcrest:{{ site.data.jcv.release.version.latest }}'
  ...
}
```
